      ...
      <div class="row">
        ...
        <div class="col-12">
          <div class="card recent-sales overflow-auto">
            ...
            <div class="card-body">
              ...
              <a  class="btn btn-success mb-3" href="/dashboard/jurusan/create">Tambah Jurusan</a>
        ...
        @foreach ($jurusan as $data)
          <tr>
            ...
            <td>
										<div class="actions">
											<a class="btn btn-success" href="/dashboard/jurusan/{{ $data->id }}/edit">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <form action="{{ route('jurusan.destroy',$data) }}" method="post" class="d-inline">
                              @method('delete')
                              @csrf
