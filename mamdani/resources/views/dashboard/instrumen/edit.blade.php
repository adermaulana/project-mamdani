...
@endif
<form action="{{ route('instrumen.update',$pernyataan->id) }}" method="POST" enctype="multipart/form-data">
@csrf
@method('PUT')
<div class="row mt-3">
...
<h6>Nama</h6>
<input type="text" name="nama" value="{{ old('nama',$pernyataan->nama) }}" class="form-control" >
@error('nama')
